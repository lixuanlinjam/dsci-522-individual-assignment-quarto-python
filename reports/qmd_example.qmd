...
We present the standard deviations in @tbl-historical.
...
Additionally, note that in @tbl-historical we consider the sample standard deviation of the number of horses during the same time span as @fig-populations.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-largest width=65%}
